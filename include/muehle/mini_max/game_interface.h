...
class GameInterface {
 public:
  ...
  virtual unsigned int GetMaxNumPossibilities() { return 0; };
  /* Total number of layers */
  virtual unsigned int GetNumberOfLayers() { return 0; };
   ...
   * algorithm */
  virtual unsigned int GetMaxNumPlies() { return 0; };
  ...
  virtual uint_1d GetPartnerLayers(unsigned int layer_num) { return {}; };
  ...
  virtual unsigned int GetLayerNumber(unsigned int thead_no) { return 0; };
  ...
  virtual bool IsStateIntegrityOk(unsigned int thread_no) { return false; }
  ...
  virtual bool LostIfUnableToMove(unsigned int thread_no) { return false; };
