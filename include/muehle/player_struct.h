...
class PlayerStruct {
 public:
  ...
  unsigned int num_stones =
      0; /* Number of stones of this player on the field */
  unsigned int num_stones_missing =
      0; /* Number of stones which has been stolen by the opponent */
  unsigned int num_stones_set = 0; /* Number of stones which have been set on
                                      the field during setting phase */
  unsigned int num_possible_moves =
      24; /* Number of possible moves (setting and moving phast). Does not
             include possible stone removals. */
  unsigned int number_of_mills =
      0; /* Number of mills belonging to this player */
  unsigned int has_only_mills = false; /* True if the player has only mills and
                                          no non mill stones on the field */
