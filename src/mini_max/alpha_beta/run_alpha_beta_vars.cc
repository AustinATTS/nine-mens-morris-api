...
mini_max::alpha_beta::RunAlphaBetaVars::RunAlphaBetaVars(
  ...
  branch_array.resize(/* new_size: */ master.r_solver.max_num_branches *
...
mini_max::alpha_beta::RunAlphaBetaVars::RunAlphaBetaVars(
    ...
    : r_solver(r_solver),
      CommonThreadVars(
          ...
          /* target_file_size: */ r_solver.db.GetNumberOfKnots(layer_number),
          r_solver.rough_total_num_states_processed,
          r_solver.total_num_states_processed, r_solver.log) {
  branch_array.resize(/* new_size: */ r_solver.max_num_branches *
                      r_solver.depth_of_full_tree);
}
